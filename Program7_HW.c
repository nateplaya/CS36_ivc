...
void totalprint(float *totalCincome, float *totalRamount, float *totalNewpay)
{
...
void main()
{
	...
	//i picked the for loop because the loop is deterministic
	...
	totalprint(&totalCincome, &totalRamount, &totalNewpay);
